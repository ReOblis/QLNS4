...
namespace QLNS.Controllers
{
    public class HopDongLaoDongsController : Controller
    {
        ...
        {
              return _context.HopDongLaoDong != null ? 
                          View(await _context.HopDongLaoDong.ToListAsync()) :
                          Problem("Entity set 'QLNSContext.HopDongLaoDong'  is null.");
        }
        ...
        {
            if (_context.HopDongLaoDong == null)
            {
                return Problem("Entity set 'QLNSContext.HopDongLaoDong'  is null.");
            }
            var hopDongLaoDong = await _context.HopDongLaoDong.FindAsync(id);
            if (hopDongLaoDong != null)
            {
